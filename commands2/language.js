					...
					col.on('collect', async (button) => {
						...
						switch (button.customId) {
							...
							case 'in':
								...
								await interaction
									?.editReply({
										content: `मैंने भाषा को हिंदी पर सेट किया :flag_in:`,
										embeds: [],
										components: [],
										ephemeral: true,
									})
							...
							case 'ph':
								...
								await interaction
									?.editReply({
										content: `Itinakda ko ang wika sa Tagalog :flag_ph:`,
										embeds: [],
										components: [],
										ephemeral: true,
									})
							...
							case 'th':
								...
								await interaction
									?.editReply({
										content: `ฉันตั้งค่าภาษาไทยเป็น :flag_th:`,
										embeds: [],
										components: [],
										ephemeral: true,
									})
