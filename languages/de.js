const language = {
	...
	error1:
		'Das Bot-Token, das Sie in Ihr Projekt eingegeben haben, ist falsch oder die INTENDS Ihres Bots sind aus!',
	error2:
		'Bitte setzen Sie das Bot-Token in token.js oder in Ihrer .env-Datei in Ihrem Projekt!',
	loadclientevent: 'Client-Ereignis geladen',
	embed1:
		'Sie brauchen die <@&{djRole}>(DJ) Rolle dieses Servers um die Befehle zu benutzen. Benutzer ohne diese Rolle können {cmdMAP} nicht verwenden.',
	...
	error4:
		'WARNUNG: Es sieht so aus als hätten Sie keine mongodb url angegeben? Wenn Sie keine valide mongodb url in der config.js Datei angeben, sind Sie nicht in der Lage den Bot zu verwenden.',
	msg13: ` Jetzt läuft:`,
	msg14:
		'Die Warteschlange ist derzeit leer. Bitte fügen Sie mehr Musik hinzu, um sie zu genießen.',
	msg15: 'Ich habe den Audiokanal verlassen, weil niemand mehr übrig ist. ',
	msg16:
		'Ich habe Probleme, mich mit dem Sprachkanal zu verbinden. Als ob mich jemand getrennt hätte?! Ich bin sehr traurig. 😔',
	...
	msg26:
		'Wenn Sie keine DJ-Rolle angeben, können Sie den Befehl nicht verwenden!',
...
Willkommen auf der **{client.user.username} Befehls-Hilfeseite!**

**Instruction**

> Verwende **/** als globales Präfix.
> Verwende **/help [gefolgt von Ihrer Frage, ob Sie unserer KI etwas fragen möchten]**, um klare Details zu sehen.

**Music Control Panel Button Instruction**

> ⏪ Taste wird verwendet, um die Musik um 15 Sekunden zurückzuspulen.
> 
> ◀️ Taste zum Abspielen des vorherigen Titels.
> 
> ⏸️ Taste zum Pausieren der Musik.
> 
> ⏯️ Taste zum Fortsetzen der Musik.
> 
> ▶️ Taste, um den aktuellen Titel zu überspringen.
> 
> ⏩ Taste wird verwendet, um die Musik um 15 Sekunden vorzuspulen.
> 
> 🔉 Taste wird verwendet, um die Lautstärke um 15 zu verringern.
> 
> 📃 Taste, um die Liedtexte anzuzeigen.
> 
> ⏹️ Taste, um die Musik zu stoppen.
> 
> <:autoplay:1230869965435961394> Taste, um die automatische Wiedergabe der Warteschlange ein- oder auszuschalten.
> 
> 🔊 Taste wird verwendet, um die Lautstärke um 15 zu erhöhen.
> 
> 🔀 Taste, um die Musik in der Warteschlange zu mischen.
> 
> <:download:1230868574722064446> Taste, um die Musik über Google Drive herunterzuladen.
> 
> ➕ Taste, um Musik oder eine Playlist zur Warteschlange hinzuzufügen.
> 
> 💾 Taste, um die Musik in deiner Playlist zu speichern.
> 
> 🔁 Taste, um die Musik in der Warteschlange zu wiederholen.
...
Möchtest du abhängen, Fehler melden oder Feedback geben? Trete dem [The Great Empire]({config.support}) bei und vernetze dich mit anderen Musikliebhabern!
...
[Invite Me]({config.botInvite}) • [Support Server]({config.support2}) • [Vote]({config.voteManager.vote_url}) • [Website]({config.supportServer}) • [Sponsor]({config.sponsor.url})
   ...
   > **Wiederholung beenden:** Beendet die Wiederholung.`,
	...
	msg55: `Ich kann Ihrem Sprachkanal nicht beitreten. <a:Cross:1116983956227772476>`,
	...
	msg85: `Die Musik hörte auf. Vielen Dank, dass Sie unseren Service nutzen. `,
	msg86: 'Aktualisieren',
	msg87: `Momentane Lautstärke: **{queue.volume}** <a:Musicon:1116994369833144350>\n**Um die Lautstärke zu ändern gib eine Zahl zwischen \`1\` und \`{maxVol}\` ein.**`,
	...
	msg110:
		'Schreiben Sie den Namen der Playlist, die Sie durchsuchen möchten. ❌',
	...
	msg118:
		'Ihre Zeit ist abgelaufen, um diesen Befehl zu verwenden, Sie können `/playlist list {name}` eingeben, um den Befehl erneut zu benutzen.',
	msg119:
		'Nutzen Sie den **/play playlist <list-name>** Befehl, um diese Playlists zu hören.\nSchreiben Sie **/playlist list <list-name>**, um die Musik in der Playlist zu sehen.',
	msg120: 'Bitte geben Sie einen Textkanal an.',
	msg121:
		'<#{channel}> wurde zu der Liste der erlaubten Textkanäle hinzugefügt. Jetzt können Befehle nur in diesen Kanälen genutzt werden.',
	...
	error7:
		'Bitte versuchen Sie diesen Befehl später erneut. Möglicher Fehler an Bot-Entwickler gemeldet.',
	msg128:
		'Du hast mich zum Schweigen gebracht, während die Musik spielte. Deshalb habe ich die Musik gestoppt. Wenn Sie die Stummschaltung rückgängig machen, werde ich fortfahren. 😔',
	msg129: 'spielt',
	msg130: 'Bitte schreiben Sie eine gültige Zahl.',
	msg131:
		'Um die Befehle in der Liste zu verwenden, müssen Sie für den Bot voten.',
	...
	msg135:
		'Die Spielzeit wurde erfoglreich auf {queue.formattedCurrentTime} eingestellt',
	msg136:
		'Autoplay ist jetzt eingeschaltet. Ich werde von nun an zufällige Musik wiedergeben.',
	msg137: 'Autoplay ist jetzt ausgeschaltet.',
	msg138: 'Kanal: **{queue?.connection.channel.name}** ',
	msg142: 'Track {trackName} wurde gelöscht.',
	msg143: 'Dauer',
	msg144: 'Nächstes Lied',
	msg145: 'Geschätzte Zeit bis zur Wiedergabe',
	msg146: 'Geschätzte Zeit',
	msg147: 'Warteschlangenposition',
	msg148:
		'Ich habe 3 Minuten gewartet, aber leider spielt immer noch keine Musik. Vielen Dank, dass Sie unseren Service gewählt haben.',

	msg149:
		'Der **{trackName}** wurde von **Warteschlange {fromOrder}** in **Warteschlange {toOrder}** verschoben.',
	msg150: 'Musik hinzufügen',
	msg151: 'Musiknamen eingeben.',
};
