const language = {
	...
	msg32: `
		...
		**{client.user.username} Komut Yardım Sayfasına** hoş geldiniz!
		
		**Instruction**

		> Genel ön ek olarak **/** kullanın.
		> Detayları görmek için **/help [sorunuzu takip eden şeyi, AI'ımıza herhangi bir şey sormak için kullanın]** kullanın.
		
		**Music Control Panel Button Instruction**

> ⏪ düğmesi, müziği 15 saniye geri sarmak için kullanılır.
> 
> ◀️ düğmesi önceki müziği çalar.
> 
> ⏸️ düğmesi müziği duraklatır.
> 
> ⏯️ düğmesi müziği devam ettirir.
> 
> ▶️ düğmesi mevcut müziği atlar.
> 
> ⏩ düğmesi, müziği 15 saniye ileri sarar.
> 
> 🔉 düğmesi sesi 15 azaltmak için kullanılır.
> 
> 📃 düğmesi şarkı sözlerini gösterir.
> 
> ⏹️ düğmesi müziği durdurur.
> 
> <:autoplay:1230869965435961394> düğmesi, kuyruğun otomatik oynatma özelliğini açar veya kapatır.
> 
> 🔊 düğmesi sesi 15 artırmak için kullanılır.
> 
> 🔀 düğmesi kuyruğundaki müziği karıştırır.
> 
> <:download:1230868574722064446> düğmesi müziği gdrive üzerinden indirir.
> 
> ➕ düğmesi kuyruğa müzik veya çalma listesi ekler.
> 
> 💾 düğmesi müziği çalma listenize kaydeder.
> 
> 🔁 düğmesi kuyruğundaki müziği döngüye alır.
		...
		**Feedback**
		...
		Sosyalleşmek, hataları bildirmek veya geribildirim vermek mi istiyorsunuz? [The Great Empire]({config.support})'a katılın ve diğer müzikseverlerle bağlantı kurun!
