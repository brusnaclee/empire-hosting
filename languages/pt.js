const language = {
	...
	msg13: ` Tocando agora:`,
	msg14:
		'A fila está atualmente vazia. Considere adicionar mais músicas para curtir.',
	...
	msg32: `
		...
		Bem-vindo à **{client.user.username} Página de Ajuda de Comandos!**
		
		**Instruction**

		> Use **/** como o prefixo global.
		> Use **/help [seguido da sua pergunta para perguntar qualquer coisa ao nosso AI]** para ver detalhes claros.
		
		**Music Control Panel Button Instruction**

		> ⏪ botão é usado para rebobinar a música em 15 segundos.
> 
> ◀️ botão para tocar a música anterior.
> 
> ⏸️ botão para pausar a música.
> 
> ⏯️ botão para retomar a música.
> 
> ▶️ botão para pular a música atual.
> 
> ⏩ botão é usado para avançar a música em 15 segundos.
> 
> 🔉 botão é usado para reduzir o volume em 15.
> 
> 📃 botão para mostrar a letra.
> 
> ⏹️ botão para parar a música.
> 
> <:autoplay:1230869965435961394> botão para ativar ou desativar a reprodução automática da fila.
> 
> 🔊 botão é usado para aumentar o volume em 15.
> 
> 🔀 botão para embaralhar a música na fila.
> 
> <:download:1230868574722064446> botão para baixar a música via gdrive.
> 
> ➕ botão para adicionar música ou playlist à fila.
> 
> 💾 botão para salvar a música na sua playlist.
> 
> 🔁 botão para repetir a música na fila.
		...
		**Feedback**
		...
		Quer socializar, relatar bugs ou dar feedback? Junte-se ao [The Great Empire]({config.support}) e conecte-se com outros amantes de música!
   ...
   > **Desligar Loop:** Desliga o loop.`,
	...
	msg55: `Eu não consigo entrar no seu canal de voz. <a:Cross:1116983956227772476>`,
	...
	msg85: `A música parou. Obrigado por usar o nosso serviço.`,
	msg86: 'Atualizar',
	msg87: `Volume atual: **{queue.volume}** <a:Musicon:1116994369833144350>\n**Parar mudar o volume, escreva um número entre \`1\` e \`{maxVol}\`.**`,
	...
	msg142: 'A faixa {trackName} foi excluída.',
	msg143: 'Duração',
	msg144: 'Próxima música',
	msg145: 'Tempo estimado até ser reproduzida',
	msg146: 'Tempo Estimado',
	msg147: 'Posição na Fila',
	msg148:
		'Eu esperei por 3 minutos, mas infelizmente ainda não há música tocando. Obrigado por escolher nosso serviço.',

	msg149:
		'A música **{trackName}** foi movida da **fila {fromOrder}** para a **fila {toOrder}**.',
	msg150: 'Adicionar Música',
	msg151: 'Escreva o nome da música.',
};
