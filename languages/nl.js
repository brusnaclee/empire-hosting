const language = {
	...
	msg13: ` Nu aan het spelen:`,
	msg14:
		'De wachtrij is momenteel leeg. Overweeg alstublieft om meer muziek toe te voegen om van te genieten.',
	msg15:
	...
	msg32: `
		...
		Welkom op de **{client.user.username} Command Help-pagina!**
		
		**Instruction**

		> Gebruik **/** als het globale voorvoegsel.
        > Gebruik **/help [gevolgd door je vraag om iets te vragen aan onze AI]** om duidelijke details te zien.
		
		**Music Control Panel Button Instruction**

> ⏪ knop wordt gebruikt om muziek 15 seconden terug te spoelen.
> 
> ◀️ knop om de vorige muziek af te spelen.
> 
> ⏸️ knop om de muziek te pauzeren.
> 
> ⏯️ knop om de muziek te hervatten.
> 
> ▶️ knop om de huidige muziek over te slaan.
> 
> ⏩ knop wordt gebruikt om muziek 15 seconden vooruit te spoelen.
> 
> 🔉 knop wordt gebruikt om het volume met 15 te verlagen.
> 
> 📃 knop om de songtekst weer te geven.
> 
> ⏹️ knop om de muziek te stoppen.
> 
> <:autoplay:1230869965435961394> knop om de autoplay van de wachtrij in of uit te schakelen.
> 
> 🔊 knop wordt gebruikt om het volume met 15 te verhogen.
> 
> 🔀 knop om de muziek in de wachtrij te shuffle.
> 
> <:download:1230868574722064446> knop om de muziek via gdrive te downloaden.
> 
> ➕ knop om muziek of afspeellijst aan de wachtrij toe te voegen.
> 
> 💾 knop om de muziek op je afspeellijst op te slaan.
> 
> 🔁 knop om de muziek in de wachtrij te herhalen.
		...
		**Feedback**
		...
		Op zoek om te socializen, bugs te melden, of feedback te geven? Doe mee aan [The Great Empire]({config.support}) en maak verbinding met andere muziekliefhebbers!
   ...
   ** **Now Playing Music:** Herhaalt het huidige nummer.
   > **Close Loop:** Stop het herhalen.`,
	...
	msg55: `Ik kan je voicekanaal niet joinen. <a:Cross:1116983956227772476>`,
	...
	msg85: `Muziek stopte. Bedankt voor het gebruik van onze service. `,
	msg86: 'Update',
	msg87: `Huidig volume: **{queue.volume}** <a:Musicon:1116994369833144350>**Om het volume te veranderen, typ een getal tussen \`1\` en \`{maxVol}\.**`,
	...
	msg138: 'anaal: **{queue?.connection.channel.name}** ',
	msg142: 'Track {trackName} is verwijderd.',
	msg143: 'Duur',
	msg144: 'Volgend nummer',
	msg145: 'Geschatte tijd tot afspelen',
	msg146: 'Geschatte tijd',
	msg147: 'Wachtrijpositie',
	msg148:
		'Ik heb 3 minuten gewacht, maar helaas speelt er nog steeds geen muziek. Bedankt voor het kiezen van onze service.',

	msg149:
		'**{trackName}** is verplaatst van **wachtrij {fromOrder}** naar **wachtrij {toOrder}**.',
	msg150: 'Muziek toevoegen',
	msg151: 'Schrijf de naam van de muziek.',
};
