...
Benvenuto nella **Pagina di Aiuto dei Comandi di {client.user.username}!**

**Instruction**

> Usa **/** come prefisso globale.
> Usa **/help [seguito dalla tua domanda per chiedere qualsiasi cosa al nostro AI]** per vedere dettagli chiari.

**Music Control Panel Button Instruction**

> ⏪ il pulsante viene utilizzato per riavvolgere la musica di 15 secondi.
> 
> ◀️ pulsante per riprodurre la musica precedente.
> 
> ⏸️ pulsante per mettere in pausa la musica.
> 
> ⏯️ pulsante per riprendere la musica.
> 
> ▶️ pulsante per saltare la musica attuale.
> 
> ⏩ il pulsante viene utilizzato per avanzare la musica di 15 secondi.
> 
> 🔉 pulsante utilizzato per abbassare il volume di 15.
> 
> 📃 pulsante per mostrare il testo della canzone.
> 
> ⏹️ pulsante per fermare la musica.
> 
> <:autoplay:1230869965435961394> pulsante per attivare o disattivare la riproduzione automatica della coda.
> 
> 🔊 pulsante utilizzato per aumentare il volume di 15.
> 
> 🔀 pulsante per mescolare la musica nella coda.
> 
> <:download:1230868574722064446> pulsante per scaricare la musica tramite gdrive.
> 
> ➕ pulsante per aggiungere musica o playlist alla coda.
> 
> 💾 pulsante per salvare la musica nella tua playlist.
> 
> 🔁 pulsante per ripetere la musica nella coda.
...
Cerchi di socializzare, segnalare bug o dare feedback? Unisciti a [The Great Empire]({config.support}) e connettiti con altri amanti della musica!
...
[Invite Me]({config.botInvite}) • [Support Server]({config.support2}) • [Vote]({config.voteManager.vote_url}) • [Website]({config.supportServer}) • [Sponsor]({config.sponsor.url})
   ...
   > **Chiudi Loop:** Chiude il loop.`,
	...
	msg150: 'Aggiungi Musica',
	msg151: 'Scrivi il nome della musica.',
};
