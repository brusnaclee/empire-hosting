const language = {
	...
	error4:
		'警告：看起來您沒有填人 Mongodb 網址？如果您在 config.js 裡沒有填人有效的 Mongodb 網址，您沒辦法使用機器人。',
	msg13: ` 現正播放：`,
	msg14: '队列目前为空。请添加更多音乐以享受。',
	...
	msg32: `
		...
		歡迎來到**{client.user.username}指令幫助頁面**！
		
		**Instruction**

		> 使用 **/** 作為全域前綴。
		> 使用 **/help [後跟您的問題以向我們的AI詢問任何事]** 以查看清晰的細節。
...
> ⏹️ 按鈕用於停止音樂。
> 
> <:save:1117815593043775569> 按鈕用於將音樂保存到您的播放列表中。
> 
> 🔀 按鈕用於將音樂隨機排列在隊列中。
> 
> <:download:1230868574722064446> 按鈕用於通過gdrive下載音樂。
> 
> <:autoplay:1230869965435961394> 按鈕用於打開或關閉隊列的自動播放。
		...
		**Feedback**
		...
		想要社交、回報問題或給予回饋嗎？加入[The Great Empire]({config.support})，與其他音樂愛好者連結吧！
   ...
   > **結束循環：** 結束目前循環`,
	...
	msg53: `您沒有權限播放此播放清單。`,
	msg54: `您沒有這個名字的音樂。`,
	msg55: `我無法加入您所在的語音頻道。 <a:Cross:1116983956227772476>`,
	msg56: `播放清單讀取中... `,
	...
	msg85: `音乐停止了。感谢您使用我们的服务。 `,
	msg86: '更新',
	msg87: `目前音量：**{queue.volume}** <a:Musicon:1116994369833144350>\n**設定音量請使用 \`1\` 到 \`{maxVol}\` 的數字。**`,
	msg88: `現在已經是這個音量了。 `,
	...
	msg137: '自動播放現已關閉。',
	msg138: '音樂頻道：**{queue?.connection.channel.name}** ',
	msg142: '軌道 {trackName} 已被刪除.',
	msg143: '持續時間',
	msg144: '下一首歌曲',
	msg145: '預計播放時間',
	msg146: '預計時間',
	msg147: '佇列位置',
	msg148: '我已经等了3分钟了，但很遗憾，还没有音乐播放。感谢您选择我们的服务。',

	msg149: '**{trackName}** 已从 **队列 {fromOrder}** 移至 **队列 {toOrder}**。',
};
