const language = {
	...
	msg32:
		'完全無料かつ高度なインターフェイスで、あなたのdiscordサーバーで楽曲を聴くときが来たのです。多くのプラットフォームでの音楽再生をサポートする音楽ボットで、あなたのサーバーを特別な雰囲気にします。ボット Web サイト: https://empire.is-great.net/',
	msg33: 'ボットのコマンド',
   ...
   > **ループを閉じる:** ループ再生をやめます。`,
	...
	msg147: 'キューの位置',
	msg148:
		'2分待ちましたが、残念ながらまだ音楽が再生されていません。当サービスをご利用いただきありがとうございます。',
};
