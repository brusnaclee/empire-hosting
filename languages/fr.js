const language = {
	...
	msg13: ` En cours de lecture:`,
	msg14:
		"La file d'attente est actuellement vide. Veuillez envisager d'ajouter plus de musique pour en profiter.",
...
Bienvenue sur la **{client.user.username} Page d'aide aux commandes!**

**Instruction**

> Utilisez **/** comme préfixe global.
> Utilisez **/help [suivi de votre question pour demander quoi que ce soit à notre IA]** pour voir les détails clairs.

**Music Control Panel Button Instruction**

> ⏪ bouton est utilisé pour rembobiner la musique de 15 secondes.
> 
> ◀️ bouton pour jouer la musique précédente.
> 
> ⏸️ bouton pour mettre la musique en pause.
> 
> ⏯️ bouton pour reprendre la musique.
> 
> ▶️ bouton pour passer la musique actuelle.
> 
> ⏩ bouton est utilisé pour avancer la musique de 15 secondes.
> 
> 🔉 bouton est utilisé pour diminuer le volume de 15.
> 
> 📃 bouton pour afficher les paroles.
> 
> ⏹️ bouton pour arrêter la musique.
> 
> <:autoplay:1230869965435961394> bouton pour activer ou désactiver la lecture automatique de la file d'attente.
> 
> 🔊 bouton est utilisé pour augmenter le volume de 15.
> 
> 🔀 bouton pour mélanger la musique dans la file d'attente.
> 
> <:download:1230868574722064446> bouton pour télécharger la musique via gdrive.
> 
> ➕ bouton pour ajouter de la musique ou une playlist à la file d'attente.
> 
> 💾 bouton pour enregistrer la musique dans ta playlist.
> 
> 🔁 bouton pour boucler la musique dans la file d'attente.
...
Vous cherchez à passer du temps, signaler des bugs ou donner votre avis ? Rejoignez [The Great Empire]({config.support}) et connectez-vous avec d'autres amateurs de musique !
...
[Invite Me]({config.botInvite}) • [Support Server]({config.support2}) • [Vote]({config.voteManager.vote_url}) • [Website]({config.supportServer}) • [Sponsor]({config.sponsor.url})
  ...
  > **Fermer la boucle :** Ferme la boucle.`,
	...
	msg55: `Je ne peux pas rejoindre votre canal vocal. <a:Cross:1116983956227772476>`,
	...
	msg85: `La musique s'est arrêtée. Merci d'utiliser notre service. `,
	msg86: 'Mettre à jour',
	msg87: `Volume actuel : **{queue.volume}** <a:Musicon:1116994369833144350>\n**Pour modifier le volume, avec \`1\` à \`{maxVol}\` Tapez un nombre entre.**`,
	...
	msg138: 'Chaîne: **{queue?.connection.channel.name}** ',
	msg142: 'La piste {trackName} a été supprimée.',
	msg143: 'Durée',
	msg144: 'Chanson suivante',
	msg145: 'Temps estimé avant la lecture',
	msg146: 'Temps estimé',
	msg147: "Position dans la file d'attente",
	msg148:
		"J'ai attendu 3 minutes, mais malheureusement, il n'y a toujours pas de musique en train de jouer. Merci d'avoir choisi notre service.",

	msg149:
		"La chanson **{trackName}** a été déplacée de la **file d'attente {fromOrder}** à la **file d'attente {toOrder}**.",
	msg150: 'Ajouter de la musique',
	msg151: 'Écrire le nom de la musique.',
};
