const language = {
	...
	msg32: `
		...
		**Music Control Panel Button Instruction**
		...
		> Кнопка ◀️ для воспроизведения предыдущей музыки.
> 
> Кнопка ⏸️ для приостановки музыки.
> 
> Кнопка ⏯️ для продолжения воспроизведения музыки.
> 
> Кнопка ▶️ для пропуска текущей музыки.
> 
> Кнопка 📃 для отображения текста песни.
> 
> Кнопка ⏹️ для остановки музыки.
> 
> Кнопка <:save:1117815593043775569> для сохранения музыки в вашем плейлисте.
> 
> Кнопка 🔀 для перемешивания музыки в очереди.
> 
> Кнопка <:download:1230868574722064446> для загрузки музыки через gdrive.
> 
> Кнопка <:autoplay:1230869965435961394> для включения или выключения автовоспроизведения в очереди.
